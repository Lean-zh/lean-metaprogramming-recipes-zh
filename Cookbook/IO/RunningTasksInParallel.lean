...
%%%
htmlSplit := .never
file := "io-running-tasks-in-parallel"
%%%
...
number := false
file := "running-tasks-in-parallel"
%%%
...
然而在许多情况下，由于派生了过多线程，你可能会造成死锁。关于如何区分并避免这类故障，请查看 {ref "deadlocking-the-task-system"}[任务系统中的阻塞与资源耗尽] 一节。
